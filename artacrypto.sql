...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 13, 2025 at 02:31 PM
...
(1, 'tes123', 'tes123@gmail.com', '$2y$10$nf7Voxzx.IxlSvdCorb9oe9P3unQ6FfisS1cO2F.MYjPJ97.Dem16', '2025-11-13 13:29:21');
...
ALTER TABLE `watchlist`
  ...
  ADD CONSTRAINT `watchlist_ibfk_2` FOREIGN KEY (`coin_id`) REFERENCES `coins` (`id`) ON DELETE CASCADE;
COMMIT;
